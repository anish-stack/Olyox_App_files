  ...
  try {
    ...
    const toggleOnlineStatus = async () => {
      try {
        ...
        if (response.data.success) {
          ...
          console.log("Setting isOnline to:", newStatus, "type:", typeof newStatus)
    ...
    const ConnectionStatus = useMemo(() => {
      try {
        ...
        console.log("Rendering ConnectionStatus, socket connected:", isConnected)
        ...
        return (
          <Animated.View
            style={[
              ...
              {
                backgroundColor: isConnected ? "#E0F7FA" : "#FFEBEE",
          ...
          >
            <MaterialCommunityIcons
              ...
              size={20}
              color={isConnected ? "#00BCD4" : "#F44336"}
            />
            <Text style={[styles.connectionText, { color: isConnected ? "#00BCD4" : "#F44336" }]}>
    ...
    }, [socket?.connected, fadeAnim, scaleAnim, user_data?._id])
    ...
    const StatusCard = useMemo(() => {
      try {
        console.log("Rendering StatusCard, isAvailable:", user_data?.isAvailable, "socket connected:", socket?.connected)
          ...
          >
            <View style={styles.statusRow}>
              <View style={styles.statusItem}>
                ...
                <Text style={[styles.statusValue, { color: isAvailable ? "#4CAF50" : "#F44336" }]}>
                  {isAvailable
                    ? "Online"
    ...
    }, [user_data?.isAvailable, user_data?.on_ride_id, socket?.connected, scaleAnim])
   ...
   console.log("user_data",user_data?.on_ride_id)
          ...
          <View style={styles.content}>
            <View style={styles.welcomeCard}>
              ...
              <TouchableOpacity
                ...
                disabled={loading === true || user_data?.on_ride_id ? true : false}
              >
                <MaterialCommunityIcons
                  name={
                    loading === true
              ...
              <TouchableOpacity
                style={[styles.reconnectButton, { backgroundColor: isSocketReady === true ? "#E0F7FA" : "#FFEBEE" }]}
                onPress={() => handleHardReconnect(user_data?._id)}
              ...
              >
                {showReconnectAnimation === true ? (
                  ...
                  <>
                    ...
                    />
                    <Text style={[styles.reconnectText, { color: isSocketReady === true ? "#00BCD4" : "#F44336" }]}>
                      {isSocketReady === true ? "Connected to Server" : "Reconnect to Server"}
                    </Text>
                  </>
                )}
              </TouchableOpacity>
    ...
    return (
      <SafeAreaView style={{ flex: 1, justifyContent: 'center', alignItems: 'center', padding: 20 }}>
        <Text style={{ fontSize: 18, fontWeight: 'bold', marginBottom: 10, color: '#F44336' }}>
