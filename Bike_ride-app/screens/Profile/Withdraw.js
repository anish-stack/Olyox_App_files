        ...
        return withdrawals.map((item, index) => (
            <View key={index} style={styles.historyItem}>
                <View style={styles.historyItemHeader}>
                    ...
                    <View style={[
                        styles.statusBadge,
                        item.status === 'Completed' ? styles.successBadge :
                            item.status === 'Pending' ? styles.pendingBadge : styles.rejectedBadge
                    ]}>
                ...
                <View style={styles.historyItemBody}>
                    ...
                    {item.method === 'UPI' && (
                        <Text style={styles.detailText}>UPI: {item.upi_details?.upi_id}</Text>
                    )}
                            ...
                            <View style={styles.formGroup}>
                                ...
                                <View style={styles.methodSelector}>
                                    <TouchableOpacity
                                        style={[
                                            styles.methodOption,
                                            formData.isUpi && styles.methodOptionActive
                                        ]}
                                    ...
                                    >
                                        <MaterialIcons
                                            name="payment"
                                            size={24}
                                            color={formData.isUpi ? COLORS.light : COLORS.primary}
                                        />
                                        <Text style={[
                                            styles.methodText,
                                            formData.isUpi && styles.methodTextActive
                                        ]}>UPI</Text>
                                    </TouchableOpacity>
                                    ...
                                    <TouchableOpacity
                                        style={[
                                            styles.methodOption,
                                            formData.isBank && styles.methodOptionActive
                                        ]}
                                    ...
                                    >
                                        ...
                                        <Text style={[
                                            styles.methodText,
                                            formData.isBank && styles.methodTextActive
                                        ]}>Bank Transfer</Text>
                                    </TouchableOpacity>
                                </View>
                            </View>
