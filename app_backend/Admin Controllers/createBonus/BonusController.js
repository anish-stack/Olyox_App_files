...
exports.createBonus = async (req, res) => {
  try {
    const { requiredHours, bonusCouponCode, bonusType, bonusValue, bonusStatus, anyRequiredField } = req.body;
...
exports.getAllBonuses = async (req, res) => {
  ...
  exports.updateBonus = async (req, res) => {
    try {
      ...
      bonus.anyRequiredField = anyRequiredField || bonus.anyRequiredField;
