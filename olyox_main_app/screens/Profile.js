...
export default function UserProfile() {
    ...
    const fetchData = async () => {
        try {
            ...
            const response = await axios.get('http://192.168.1.23:3100/api/v1/user/find-Orders-details', {
    ...
    const uploadImage = async () => {
        ...
        try {
            ...
            const response = await axios.post('http://192.168.1.23:3100/api/v1/user/update-profile', form, {
                headers: {
