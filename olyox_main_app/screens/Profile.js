...
export default function OlyoxUserProfile() {
    ...
    const fetchData = useCallback(async () => {
        try {
            ...
            const response = await axios.get('http://192.168.1.11:3100/api/v1/user/find-Orders-details', {
    ...
    const uploadImage = useCallback(async () => {
        ...
        try {
            ...
            const response = await axios.post('http://192.168.1.11:3100/api/v1/user/update-profile', form, {
                headers: {
    ...
    const deleteAccount = useCallback(async (id) => {
        try {
            setLoading(true);
            const response = await axios.post(`http://192.168.1.11:3100/api/v1/user/delete-my-account/${id}`);
                    ...
                    >
                        <View style={styles.headerActions}>
                            <View style={styles.olyoxBranding}>
                                ...
                                <Text style={styles.olyoxTagline}>Book Cab, Hotels, Food</Text>
                            </View>
                            <TouchableOpacity
