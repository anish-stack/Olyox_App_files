...
const Checkout = () => {
    ...
    const findCurrent = useCallback(async () => {
        try {
            const data = await axios.post(`http://192.168.1.23:3100/Fetch-Current-Location`, {
    ...
    const fetchCoupons = useCallback(async () => {
        ...
        try {
            const response = await axios.get("http://192.168.1.23:3100/api/v1/tiffin/tiffin-coupons")
    ...
    const handlePlaceOrder = useCallback(async () => {
        ...
        try {
            const response = await axios.post(
                `http://192.168.1.23:3100/api/v1/tiffin/create_order_of_food`,
                {
                    order_items: items,
