...
const BACKEND_URL = 'http://192.168.1.2:3100/api/v1/user'
...
export const find_me = async () => {
  try {
    ...
    const data = await axios.get(`http://192.168.1.2:3100/api/v1/user/find_me`, {
      headers: {
...
export const findSettings = async () => {
  try {
    const response = await axios.get(`http://192.168.1.2:3100/api/v1/admin/get_Setting`)
