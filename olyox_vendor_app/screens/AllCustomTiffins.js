  ...
  const handleFetchTiffin = async () => {
    ...
    try {
      ...
      const { data } = await axios.get(
        'http://192.168.1.12:3100/api/v1/tiffin/get_custom_tiffin_by_resutrant_id',
        {
          headers: {
    ...
    Alert.alert(
      ...
      [
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: async () => {
            try {
              await axios.delete(`http://192.168.1.12:3100/api/v1/tiffin/delete_custom_tiffin/${id}`);
              handleFetchTiffin();
  ...
  const handleUpdateTiffinAvailability = async (id, food_availability) => {
    try {
      ...
      const response = await axios.put(
        `http://192.168.1.12:3100/api/v1/tiffin/update_tiffin_availability/${id}`,
