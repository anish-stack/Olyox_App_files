  ...
  const handleFetchFood = async () => {
    ...
    try {
      ...
      const { data } = await axios.get(
        'http://192.168.1.23:3100/api/v1/tiffin/get_food_by_resutrant_id',
        {
          headers: {
    ...
    Alert.alert(
      ...
      [
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: async () => {
            try {
              await axios.delete(`http://192.168.1.23:3100/api/v1/tiffin/delete_tiffin_listing/${id}`);
              handleFetchFood();
  ...
  const handleUpdateFoodAvailableStatus = async (id, food_availability) => {
    try {
      ...
      const res = await axios.put(
        `http://192.168.1.23:3100/api/v1/tiffin/update_available_food_status/${id}`,
